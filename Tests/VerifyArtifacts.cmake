...
if(EXPECT_AU)
    ...
    foreach(forbidden_resource IN ITEMS
            "network.client"
            "temporary-exception.files.all.read-write")
        string(FIND "${au_plist_contents}" "${forbidden_resource}" forbidden_resource_index)
        if(NOT forbidden_resource_index EQUAL -1)
            message(FATAL_ERROR "AU Info.plist exposes unrelated resource usage: ${forbidden_resource}")
        endif()
    endforeach()
