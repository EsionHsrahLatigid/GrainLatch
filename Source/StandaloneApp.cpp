...
namespace
{
class GrainLatchStandaloneApplication final : public juce::JUCEApplication
{
public:
    GrainLatchStandaloneApplication()
    {
...
START_JUCE_APPLICATION(GrainLatchStandaloneApplication)
